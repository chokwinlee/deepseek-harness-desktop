...
test('registers Desktop plugin management inside native Settings', async () => {
  ...
  assert.match(manager, /@deepseek-ai\/dsh-subagent-codex/)
  assert.match(manager, /@deepseek-ai\/dsh-subagent-claude-code/)
  assert.match(manager, /configure-codex-preset/)
  assert.match(manager, /configure-claude-code-preset/)
  assert.match(manager, /Standard \+ Codex/)
  assert.match(manager, /Standard \+ Claude Code/)
  assert.match(manager, /api\.agentPresets\.list/)
  assert.match(manager, /api\.settings\.update/)
  assert.doesNotMatch(manager, /dangerously-bypass-approvals-and-sandbox/)
  assert.match(bridge, /'configure-codex-preset'/)
  assert.match(bridge, /'configure-claude-code-preset'/)
  assert.match(bridge, /detail\.type === 'codex-configured'/)
  assert.match(bridge, /detail\.type === 'claude-code-configured'/)
  ...
  assert.match(native, /CODEX_SUBAGENT/)
  assert.match(native, /CLAUDE_CODE_SUBAGENT/)
  assert.match(native, /"configure-codex-preset"/)
  assert.match(native, /"configure-claude-code-preset"/)
  assert.match(native, /perform_product_subagent_preset_configuration/)
