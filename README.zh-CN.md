...
[迁移与恢复说明](docs/HARNESS_0.1.5_MIGRATION.md)
...
1. 打开 [`v0.5.0` 正式版页面](https://github.com/chokwinlee/deepseek-harness-desktop/releases/tag/v0.5.0)，在电脑安装该页面提供的 Desktop 包。
2. 在 Android 8.0 或更高版本的设备下载 `DSH-Remote-Android-v0.5.0.apk`。系统询问时，可以临时为打开文件的浏览器或文件管理器允许“安装未知应用”。
...
| Windows 10/11 | x64 安装版 | `DSH-Desktop-0.5.0-win-x64.exe` |
| Windows 10/11 | x64 便携版 | `DSH-Desktop-0.5.0-win-x64.zip` |
| Android 8.0+ | 通用 APK | `DSH-Remote-Android-v0.5.0.apk` |
