...
(() => {
  ...
  function copyFor(language) {
    return language === 'zh'
      ? {
          title: '手机 Remote',
          description: '在 iPhone 或 Android 手机上继续查看这台电脑里的项目、会话和正在运行的任务。',
          connect: '连接手机',
          manage: '管理连接',
          ...
          lanTitle: '同一 Wi-Fi',
          lanBadge: '推荐',
          lanDescription: '手机与电脑连接同一个可信 Wi-Fi，无需安装或配置 Tailscale。',
          ...
          lanResetBody: '当前二维码和所有已保存它的手机将立即失效。',
          lanResetRevoke: '已经配对的手机需要重新扫描二维码。',
          ...
          unavailable: '需要先在电脑和手机安装 Tailscale，并登录同一个 Tailnet。',
          ...
          guideStepIPhoneTitle: '在手机登录同一账号',
          guideStepIPhoneDetail: '在 iPhone 或 Android 安装 Tailscale，允许 VPN 配置，并确认电脑与手机出现在同一个 Tailnet。',
          ...
          guideStepTestDetail: '在 Remote 扫描二维码，然后关闭手机 Wi-Fi，只保留蜂窝网络和 Tailscale 再发送一条消息。',
          guideMacLink: '下载 Mac 版',
          guideIPhoneLink: '下载 iPhone 版',
          guideAndroidLink: '下载 Android 版',
          ...
          modalBody: '在 DSH Remote 中扫描二维码。电脑和手机必须登录同一个 Tailnet。',
          lanModalBody: '让手机与电脑连接同一个受信任的 Wi-Fi，然后扫描二维码。配对凭据只会显示在二维码中。',
          address: '电脑地址',
          copy: '复制配对链接',
          copied: '已复制',
          close: '完成',
      ...
      : {
          title: 'Mobile Remote',
          description: 'Continue with this computer’s projects, sessions, and running tasks from iPhone or Android.',
          ...
          lanDescription: 'Connect your phone and this computer to the same trusted Wi-Fi. Tailscale is not required.',
          ...
          lanResetBody: 'The current QR code and every phone that saved it will stop working immediately.',
          lanResetRevoke: 'Previously paired phones must scan the new QR code.',
          ...
          tailscaleDescription: 'Use your own Tailscale network when the phone is away from local Wi-Fi.',
          tailscaleChecking: 'Checking Tailscale status…',
          unavailable: 'Install Tailscale on this computer and phone, then sign in to the same tailnet.',
          ...
          guideStepIPhoneTitle: 'Use the same account on your phone',
          guideStepIPhoneDetail: 'Install Tailscale on iPhone or Android, allow the VPN configuration, and confirm the computer and phone are in the same tailnet.',
          ...
          guideStepTestDetail: 'Scan the QR code in Remote, turn off phone Wi-Fi, keep cellular and Tailscale on, then send a message.',
          guideMacLink: 'Download for Mac',
          guideIPhoneLink: 'Download for iPhone',
          guideAndroidLink: 'Download for Android',
          ...
          lanModalBody: 'Connect your phone and this computer to the same trusted Wi-Fi, then scan. The pairing credential is only carried by the QR code.',
  ...
  function renderTailscaleGuide() {
    ...
    const steps = [
      ...
      },
      {
        ...
        links: [
          [copy.guideIPhoneLink, 'https://tailscale.com/download/ios'],
          [copy.guideAndroidLink, 'https://tailscale.com/download/android'],
        ],
      },
      {
